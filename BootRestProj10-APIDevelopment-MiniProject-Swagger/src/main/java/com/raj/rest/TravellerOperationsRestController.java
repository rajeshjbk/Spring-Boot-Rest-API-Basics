...
@Tag(name = "Traveller Controller", description = "Traveller Management APIs")
public class TravellerOperationsRestController {
	...
	@PostMapping("/save")
	@Operation(
            summary = "Register Traveller",
            description = "This API registers a new traveller into the system"
    )
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Traveller registered successfully"),
